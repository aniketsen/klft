...
namespace klft {
  ...
  void HMC_U1_4D(const size_t &LX, const size_t &LY, const size_t &LZ, const size_t &LT,
    ...
    std::cout << "Running HMC_U1_4D" << std::endl;
    ...
    {
      using Group = U1<T>;
      using Adjoint = AdjointU1<T>;
      using GaugeFieldType = GaugeField<T,Group,4,1>;
      using AdjointFieldType = AdjointField<T,Adjoint,4,1>;
      using RNG = Kokkos::Random_XorShift1024_Pool<Kokkos::DefaultExecutionSpace>;
      using HamiltonianFieldType = HamiltonianField<T,Group,Adjoint,4,1>;
      RNG rng = RNG(seed);
      std::mt19937 mt(seed);
  ...
  void HMC_U1_3D(const size_t &LX, const size_t &LY, const size_t &LT,
                 const size_t &n_traj, const size_t &n_steps, const T &tau, const T &beta,
                 const size_t &seed, const std::string &outfilename) {
    std::cout << "Running HMC_U1_3D" << std::endl;
    std::cout << "Gauge Field Dimensions:" << std::endl;
    std::cout << "LX = " << LX << std::endl;
    std::cout << "LY = " << LY << std::endl;
    std::cout << "LT = " << LT << std::endl;
    ...
    Kokkos::initialize();
    {
      ...
      using AdjointFieldType = AdjointField<T,Adjoint,3,1>;
      using RNG = Kokkos::Random_XorShift1024_Pool<Kokkos::DefaultExecutionSpace>;
      using HamiltonianFieldType = HamiltonianField<T,Group,Adjoint,3,1>;
      RNG rng = RNG(seed);
      std::mt19937 mt(seed);
      std::uniform_real_distribution<T> dist(0.0,1.0);
  ...
  void HMC_U1_2D(const size_t &LX, const size_t &LT,
                 const size_t &n_traj, const size_t &n_steps, const T &tau, const T &beta,
                 const size_t &seed, const std::string &outfilename) {
    std::cout << "Running HMC_U1_2D" << std::endl;
    std::cout << "Gauge Field Dimensions:" << std::endl;
    std::cout << "LX = " << LX << std::endl;
    std::cout << "LT = " << LT << std::endl;
    std::cout << "HMC Parameters:" << std::endl;
    ...
    Kokkos::initialize();
    {
      ...
      using AdjointFieldType = AdjointField<T,Adjoint,2,1>;
      using RNG = Kokkos::Random_XorShift1024_Pool<Kokkos::DefaultExecutionSpace>;
      using HamiltonianFieldType = HamiltonianField<T,Group,Adjoint,2,1>;
      RNG rng = RNG(seed);
      std::mt19937 mt(seed);
      std::uniform_real_distribution<T> dist(0.0,1.0);
  ...
  template void HMC_U1_4D<float>(const size_t &LX, const size_t &LY, const size_t &LZ, const size_t &LT,
                                  const size_t &n_traj, const size_t &n_steps, const float &tau, const float &beta,
                                  const size_t &seed, const std::string &outfilename);

  template void HMC_U1_4D<double>(const size_t &LX, const size_t &LY, const size_t &LZ, const size_t &LT,
                                   const size_t &n_traj, const size_t &n_steps, const double &tau, const double &beta,
                                   const size_t &seed, const std::string &outfilename);

  template void HMC_U1_3D<float>(const size_t &LX, const size_t &LY, const size_t &LT,
                                 const size_t &n_traj, const size_t &n_steps, const float &tau, const float &beta,
                                 const size_t &seed, const std::string &outfilename);

  template void HMC_U1_3D<double>(const size_t &LX, const size_t &LY, const size_t &LT,
                                  const size_t &n_traj, const size_t &n_steps, const double &tau, const double &beta,
                                  const size_t &seed, const std::string &outfilename);

  template void HMC_U1_2D<float>(const size_t &LX, const size_t &LT,
                                 const size_t &n_traj, const size_t &n_steps, const float &tau, const float &beta,
                                 const size_t &seed, const std::string &outfilename);

  template void HMC_U1_2D<double>(const size_t &LX, const size_t &LT,
                                  const size_t &n_traj, const size_t &n_steps, const double &tau, const double &beta,
                                  const size_t &seed, const std::string &outfilename);                                                                                                                                        
