...
namespace klft {
  ...
  template void HMC_U1_4D<float>(const int &LX, const int &LY, const int &LZ, const int &LT,
                                  const size_t &n_traj, const size_t &n_steps, const float &tau, const float &beta,
                                  const size_t &seed, const std::string &outfilename);

  template void HMC_U1_4D<double>(const int &LX, const int &LY, const int &LZ, const int &LT,
                                   const size_t &n_traj, const size_t &n_steps, const double &tau, const double &beta,
                                   const size_t &seed, const std::string &outfilename);

  template void HMC_U1_3D<float>(const int &LX, const int &LY, const int &LT,
                                 const size_t &n_traj, const size_t &n_steps, const float &tau, const float &beta,
                                 const size_t &seed, const std::string &outfilename);

  template void HMC_U1_3D<double>(const int &LX, const int &LY, const int &LT,
                                  const size_t &n_traj, const size_t &n_steps, const double &tau, const double &beta,
                                  const size_t &seed, const std::string &outfilename);

  template void HMC_U1_2D<float>(const int &LX, const int &LT,
                                 const size_t &n_traj, const size_t &n_steps, const float &tau, const float &beta,
                                 const size_t &seed, const std::string &outfilename);

  template void HMC_U1_2D<double>(const int &LX, const int &LT,
                                  const size_t &n_traj, const size_t &n_steps, const double &tau, const double &beta,
                                  const size_t &seed, const std::string &outfilename);                                                                                                                                        
