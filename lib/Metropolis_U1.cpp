...
namespace klft {
  ...
  template void Metropolis_U1_4D<float>(const int &LX, const int &LY, const int &LZ, const int &LT, 
                                        const size_t &n_hit, const float &beta, const float &delta,
                                        const size_t &seed, const size_t &n_sweep, const bool cold_start,
                                        const std::string &outfilename);

  template void Metropolis_U1_4D<double>(const int &LX, const int &LY, const int &LZ, const int &LT, 
                                         const size_t &n_hit, const double &beta, const double &delta,
                                         const size_t &seed, const size_t &n_sweep, const bool cold_start,
                                         const std::string &outfilename);

  template void Metropolis_U1_3D<float>(const int &LX, const int &LY, const int &LT, 
                                        const size_t &n_hit, const float &beta, const float &delta,
                                        const size_t &seed, const size_t &n_sweep, const bool cold_start,
                                        const std::string &outfilename);

  template void Metropolis_U1_3D<double>(const int &LX, const int &LY, const int &LT,
                                         const size_t &n_hit, const double &beta, const double &delta,
                                         const size_t &seed, const size_t &n_sweep, const bool cold_start,
                                         const std::string &outfilename);

  template void Metropolis_U1_2D<float>(const int &LX, const int &LT,
                                        const size_t &n_hit, const float &beta, const float &delta,
                                        const size_t &seed, const size_t &n_sweep, const bool cold_start,
                                        const std::string &outfilename);  

  template void Metropolis_U1_2D<double>(const int &LX, const int &LT,
                                         const size_t &n_hit, const double &beta, const double &delta,
                                         const size_t &seed, const size_t &n_sweep, const bool cold_start,
                                         const std::string &outfilename);                                                                                                                                                                                                                                          
